...
if __name__ == "__main__":
    ...
    if function_name == "calculate_cointegration":
        series1 = json.loads(sys.argv[2])
        series2 = json.loads(sys.argv[3])
        window = int(sys.argv[4])
        coint_result = calculate_cointegration(series1, series2, window)
        print(json.dumps(coint_result, ignore_nan=True))
